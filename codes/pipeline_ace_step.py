...
class ACEStepPipeline:
    ...
    def load_checkpoint(self, checkpoint_dir=None, export_quantized_weights=False):
        ...
        ###
        logger.info(f"🔄 Loading MusicDCAE (with vocoder) from: {dcae_model_path}")
        ...
        ###
        logger.info(f"🔄 Loading ACE Step Transformer from: {ace_step_model_path}")
        ...
        ###
        logger.info(f"✅ Initializing VoiceBpeTokenizer...")
        self.lyric_tokenizer = VoiceBpeTokenizer()
        ###
        logger.info(f"🔄 Loading Text Encoder (UMT5) from: {text_encoder_model_path}")
        ...
        ###
        logger.info(f"🔄 Loading tokenizer from: {text_encoder_model_path}")
        ...
        if self.torch_compile:
            ...
            if export_quantized_weights:
                ###
                logger.info("⚙️ Quantizing weights using torchao.int4...")
